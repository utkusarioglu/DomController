...
class BaseController extends separator_handler_1.SeparatorHandler {
    ...
    announce(scope, sender_namespace, recipient_namespace, talk, delay = false) {
        const expression_trail = resolver_1.Resolution.extract_ExpressionTrail_FromResolutionInstruction(talk);
    ...
    subscribe(scope, subcribed_namespace, listen, callback) {
        const expression_trail = resolver_1.Resolution.extract_ExpressionTrail_FromResolutionInstruction(listen);
